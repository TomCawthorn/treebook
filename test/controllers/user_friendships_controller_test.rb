	...
	context "#index" do
		...
		context "when logged in" do
			...
			setup do
				...
				@friendship3 = create(:requested_user_friendship, user: users(:tom), friend: create(:user, first_name: 'Requested', last_name: 'Friend'))
				@friendship4 = user_friendships(:blocked_by_tom)
